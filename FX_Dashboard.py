...
with tab3:
    ...
    if df is None:
        st.error("No Treasury yield data could be retrieved. This may be due to connectivity issues or changes in the Treasury website format.")
    else:
        latest = df.iloc[-1]
        ...
        # Percent changes (%)
        pct_3mo = (three_mo - three_mo_prev) * 100
        pct_5y  = (five_yr - five_yr_prev) * 100
        pct_10y = (ten_yr - ten_yr_prev) * 100
        pct_30y = (thirty_yr - thirty_yr_prev) * 100
